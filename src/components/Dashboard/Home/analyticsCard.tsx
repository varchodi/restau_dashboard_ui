...
const AnalyticsCard = ({
  ...
  return (
    <div className="w-full sm:w-[250px]  flex flex-col justify-between gap-6 bg-gray-200 dark:bg-slate-900 rounded-lg p-4 text-start hover:shadow-md dark:shadow-slate-900">
